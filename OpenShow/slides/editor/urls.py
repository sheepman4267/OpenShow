...
urlpatterns = [
    ...
    path('segment/reorder', ChangeSegmentOrderView.as_view(), name='reorder-segment'),
    ...
    path('transition/<int:pk>/css_preview', TransitionPreviewCSSView.as_view(), name='css-preview'),
    ...
    path('transition/<int:pk>/demo', TransitionDemoView.as_view(), name='transition-demo'),
